...
txRectangle (0, 0, 800, 600);
 ...
 void drawPonti()
 {
  ...
  void drawOpasno()
  {
    ...
    txSetColor (TX_WHITE);
    txSetFillColor (RGB(163, 73, 164));
    POINT riji[7] = {{414, 163}, {446, 306}, {537, 442}, {626, 447}, {721, 317}, {752, 154}, {757, 87}};//овал лица
    txPolygon (riji, 7);
    ...
    txSetColor (TX_WHITE);
    POINT haha[5] = {{527, 330}, {551, 323}, {578, 329}, {605, 325}, {632, 333}};//рот
    txPolygon (haha, 5);
    ...
    txSetColor (TX_WHITE);
    txSetFillColor (TX_WHITE);
    POINT glaz[4] = {{460, 159}, {475, 171}, {529, 169}, {531, 155}};
    txPolygon (glaz, 4);

    txSetColor (TX_WHITE);
    txSetFillColor (TX_WHITE);
    POINT glaz2[4] = {{634, 154}, {637, 165}, {680, 168}, {709, 123}};
    txPolygon (glaz2, 4);


     txSetColor (TX_WHITE);
     txSetFillColor (RGB(247, 227, 119));
     POINT shlapa[3] = {{795, 78}, {511, 6}, {289, 189}};
     txPolygon (shlapa, 3);
    ...
    while(xNevidimka2 < 850)
     {
      ...
      //тут проблема! кадр сверху не появляется
