 ...
 void drawPara2()
{
    ...
    txLine (289, 460, 261, 521);
    txCircle (289, 386, 25);
    txTextOut (229, 227, "Ой спасибо :3 .");
 ...
 void drawYaponec()
{
    ...
    txSetColor (TX_BLACK);
    txSetFillColor (RGB(185, 122, 87));//стена
    txRectangle (477, 341, 800, 106);

    txSetColor (TX_BLACK);
    txSetFillColor (RGB(243, 233, 226));
    txRectangle (497, 323, 659, 122);//та бумажная штука

    txSetColor (TX_BLACK);
    txSetFillColor (RGB(243, 233, 226));
    txRectangle (689, 323, 800, 122);//вторая та бумажная штука



    txSetColor (TX_BLACK);
    txSetFillColor (RGB(237, 28, 36));
    POINT krisha[5] = {{373, 107}, {476, 106}, {639, 1}, {800, 1}, {800, 107}};//крыша
    txPolygon (krisha, 5);



    txSetColor (TX_WHITE);
    txLine (204, 306, 204, 219);//тело
    txLine (111, 204, 204, 219);// рука левая
    txLine (254, 306, 204, 219);//рука правая
    txLine (235, 398, 204, 306);//нога правая
    txLine (170, 400, 204, 306);//нога левая


    txSetColor (TX_WHITE);
    txSetFillColor (RGB(163, 73, 164));
    txCircle (202, 197, 25);//голова

    txSetColor (TX_BLACK);
    txSetFillColor (RGB(247, 227, 119));
    POINT shlapa[3] = {{138, 174}, {208, 133}, {274, 174}};//шляпа
    txPolygon (shlapa, 3);
    ...
    POINT mech[4] = {{249, 322}, {208, 338}, {178, 336}, {242, 306}};//меч ДОДЕДАТЬ!
    txPolygon (mech, 4);
 ...
 void drawRoja()
{
    ...
    txSetFillColor (TX_WHITE);
    POINT Gubi[7] = {{150, 373}, {170, 373}, {182, 384}, {202, 384}, {223, 400}, {196, 411}, {157, 396}};//губы
    txPolygon (Gubi, 7);

    POINT brov1[4] = {{127, 198}, {156, 187}, {206, 256}, {147, 199}};//бровь слева (от экрана)
    txPolygon (brov1, 4);


    POINT brov2[5] = {{355, 265}, {348, 241}, {266, 257}, {247, 270}, {336, 254}};//бровь справа (от экрана)
    txPolygon (brov2, 5);

    POINT glaz1[8] = {{139, 229}, {147, 232}, {152, 230}, {187, 249}, {192, 258}, {173, 265}, {145, 257}, {137, 232}};//глаз слева (от экрана)
    txPolygon (glaz1, 8);


    POINT glaz2[7] = {{264, 283}, {274, 276}, {309, 283}, {325, 293}, {307, 308}, {280, 303}, {265, 286}};//глаз справа (от экрана)
    txPolygon (glaz2, 7);
 ...
 void drawOpasno(int x)
{
    ...
    txSetColor (TX_WHITE);
    txSetFillColor (RGB(163, 73, 164));
    POINT riji[7] = {{x+414-414, 163}, {x+446-414, 306}, {x+537-414, 442}, {x+626-414, 447}, {x+721-414, 317}, {x+752-414, 154}, {x+757-414, 87}};//овал лица
    txPolygon (riji, 7);

    txSetColor (TX_WHITE);
    POINT haha[5] = {{x+527-414, 330}, {x+551-414, 323}, {x+578-414, 329}, {x+605-414, 325}, {x+632-414, 333}};//рот
    txPolygon (haha, 5);
 ...
 void drawDead()
{
    ...
    POINT glyz1[8] = {{139, 229}, {147, 232}, {152, 230}, {187, 249}, {192, 258}, {173, 265}, {145, 257}, {137, 232}};//глаз слева (от экрана)
    txPolygon (glyz1, 8);


    POINT glyz2[7] = {{264, 283}, {274, 276}, {309, 283}, {325, 293}, {307, 308}, {280, 303}, {265, 286}};//глаз справа (от экрана)
    txPolygon (glyz2, 7);
 ...
 void drawTitri()
{
    ...
    txSetColor(TX_WHITE);
    txSetFillColor(RGB(163, 73, 164));
    txDrawText   (100, 250, 700, 550, "КОНЕЦ \n"
                        "В главных ролях:\n"
                         "Луна-Райан Гослинг\n"
                         "Девушка-Дженифер Лопес\n"
                         "Парень-Майкл Джордан\n"
                         "Король-Доминик Торетто\n"
                         "Японец-Сергей Мавроди\n"
                         "Продюсер, сценарист, режисёр-Я\n"
                         "Спонцеры-Сергей Николаивич, Мама, Папа\n");
